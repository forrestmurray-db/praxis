...
peoplePrepared = (people
                  .withColumn('name_concat', F.lower(F.concat(people.firstName, people.middleName, people.lastName)))
                  .withColumn('ssn_proc', F.regexp_replace(people.ssn, '-', ''))
)

# COMMAND ----------

display(peoplePrepared)

# COMMAND ----------

peopleDeduped = peoplePrepared.drop_duplicates(['name_concat', 'ssn_proc']).drop('name_concat', 'ssn_proc')

# COMMAND ----------

peopleDeduped.repartition(8).write.parquet(dest_file)
